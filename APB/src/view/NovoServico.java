	...
	public NovoServico() {
		...
		botaoSalvar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				try {
					data = new java.sql.Date(format.parse(textData.getText()).getTime());
				...
				if(textServico.getText().isEmpty() || textValor.getText().isEmpty() 
						|| textBarbeiro.getText().isEmpty() || textData.getText().isEmpty())
				{
				...
				}else
				{
					...
					JOptionPane.showMessageDialog(null, "Servico " +textServico.getText()+" inserido com sucesso");	
