...
public class AlterarServico extends JFrame {
	...
	public AlterarServico() {
		...
		try {
			...
			ResultSet rs = connection.createStatement().executeQuery("DELETE FROM servico WHERE "
							+ "nome = '" + PesquisarServico.getTempNome() + "';");
